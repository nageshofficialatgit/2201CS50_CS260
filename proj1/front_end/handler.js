...
function populateTable(jsonData, tableId) {
    ...
    jsonData.forEach(function(rowData) {
      ...
      // Iterate through each key in the row data
      Object.keys(rowData).forEach(function(key) {
        // Create a new cell and set its inner HTML to the value from the JSON object
  ...
  function populateTable_alt(jsonData, tableId) {
    var tableBody = document.getElementById(tableId).getElementsByTagName('tbody')[0];
    ...
    jsonData.forEach(function(rowData) {
      ...
      // Iterate through each key in the row data, starting from the second element
      Object.keys(rowData).slice(1).forEach(function(key) {
        // Create a new cell and set its inner HTML to the value from the JSON object
        var cell = row.insertCell();
        cell.innerHTML = rowData[key];
      });
...
function populateTable_num(jsonData, tableId) {
    var tableBody = document.getElementById(tableId).getElementsByTagName('tbody')[0];
    ...
    jsonData.forEach(function(rowData) {
      ...
      serialCell.innerHTML = srno++;

      // Iterate through each key in the row data
      Object.keys(rowData).slice(1).forEach(function(key) {
        // Skip the serial number key
        if (key !== 'srno') {
          // Create a new cell and set its inner HTML to the value from the JSON object
          var cell = row.insertCell();
          cell.innerHTML = rowData[key];
       ...
       setTableData(document.getElementsByTagName('table')[1], data[0].training);
        setTableData(document.getElementsByTagName('table')[2], data[0].award);
         setTableData(document.getElementsByTagName('table')[3], data[0].spon_project);
            ...
            if (data[1]) {   document.getElementsByClassName("welcome-name")[0].innerHTML = "Welcome : " + data[1].First_Name + " " + data[1].Last_Name;
    }
}
    // do validaton here  
    catch (error) {
...
async function get_page0() {
   
   // console.log("nasa")

    try {
        const response = await fetch("http://localhost:8080/api/get_pdf_info/"+ localStorage.getItem("email") , {
            method: "GET",
            cache: "no-cache",
        //  mode : "no-cors" ,
            headers: {
        ...
        console.log(data) ;
      //  console.log(data); // Log the response data received from the server
    document.getElementById("page_1tag1").innerHTML = data[0].personal_details[0] + " " + data[0].personal_details[1] + " " + data[0].personal_details[2]
        // Assuming the server returns a message indicating the signup status
        document.getElementById("page_1tag3").innerHTML = "Date of Application :-"+ data[0].DOA.substring(0,10)
        document.getElementById("page_1tag6").innerHTML = data[0].APP_NO
        document.getElementById("page_1tag7").innerHTML = data[0].personal_details[0]
        document.getElementById("page_1tag8").innerHTML = data[0].personal_details[1] 
        document.getElementById("page_1tag9").innerHTML = data[0].personal_details[2] 
        document.getElementById("page_1tag10").innerHTML =  data[0].personal_details[4]
        document.getElementById("page_1tag11").innerHTML = data[0].personal_details[5]
        document.getElementById("page_1tag12").innerHTML = data[0].personal_details[6]
        document.getElementById("page_1tag13").innerHTML = data[0].personal_details[7]
        document.getElementById("page_1tag14").innerHTML = data[0].personal_details[8]
        document.getElementById("page_1tag16").innerHTML = data[0].personal_details[9]
        document.getElementById("page_1tag17").innerHTML = data[0].correspondence_address[0]
        document.getElementById("page_1tag18").innerHTML = data[0].correspondence_address[1]
        document.getElementById("page_1tag19").innerHTML = data[0].correspondence_address[2]
        document.getElementById("page_1tag20").innerHTML = data[0].correspondence_address[3]
        document.getElementById("page_1tag21").innerHTML = data[0].correspondence_address[4]
        document.getElementById("page_1tag22").innerHTML = data[0].permanent_address[0]
        document.getElementById("page_1tag23").innerHTML = data[0].permanent_address[1]
        document.getElementById("page_1tag24").innerHTML = data[0].permanent_address[2]
        document.getElementById("page_1tag25").innerHTML = data[0].permanent_address[3]
        document.getElementById("page_1tag26").innerHTML = data[0].permanent_address[4]
        document.getElementById("page_1tag27").innerHTML = data[0].Mobile
        document.getElementById("page_1tag28").innerHTML = data[0].alternate_mobile
        document.getElementById("page_1tag29").innerHTML = data[0].landline_no
        document.getElementById("page_1tag30").innerHTML = data[0].email
        document.getElementById("page_1tag31").innerHTML = data[0].alternate_email


        document.getElementById("page_2tag1").innerHTML = data[0].educational_qualifications[0]
        document.getElementById("page_2tag2").innerHTML = data[0].educational_qualifications[1]
        document.getElementById("page_2tag3").innerHTML = data[0].educational_qualifications[2]
        document.getElementById("page_2tag4").innerHTML = data[0].educational_qualifications[3]
        document.getElementById("page_2tag5").innerHTML = data[0].educational_qualifications[4]
        document.getElementById("page_2tag6").innerHTML = data[0].educational_qualifications[5]
        document.getElementById("page_2tag7").innerHTML = data[0].educational_qualifications[6]

        document.getElementById("page_2tag8").innerHTML = data[0].acadmic_details_m_tech[0]
        document.getElementById("page_2tag9").innerHTML = data[0].acadmic_details_m_tech[1]
        document.getElementById("page_2tag10").innerHTML = data[0].acadmic_details_m_tech[2]
        document.getElementById("page_2tag11").innerHTML = data[0].acadmic_details_m_tech[3]
        document.getElementById("page_2tag12").innerHTML = data[0].acadmic_details_m_tech[4]
        document.getElementById("page_2tag13").innerHTML = data[0].acadmic_details_m_tech[5]
        document.getElementById("page_2tag14").innerHTML = data[0].acadmic_details_m_tech[6]
        document.getElementById("page_2tag15").innerHTML = data[0].acadmic_details_m_tech[7]


        document.getElementById("page_2tag16").innerHTML = data[0].academic_details_b_tech[0]
        document.getElementById("page_2tag17").innerHTML = data[0].academic_details_b_tech[1]
        document.getElementById("page_2tag18").innerHTML = data[0].academic_details_b_tech[2]
        document.getElementById("page_2tag19").innerHTML = data[0].academic_details_b_tech[3]
        document.getElementById("page_2tag20").innerHTML = data[0].academic_details_b_tech[4]
        document.getElementById("page_2tag21").innerHTML = data[0].academic_details_b_tech[5]
        document.getElementById("page_2tag22").innerHTML = data[0].academic_details_b_tech[6]
        document.getElementById("page_2tag23").innerHTML = data[0].academic_details_b_tech[7]

        document.getElementById("page_2tag24").innerHTML = data[0].acadmic_details_school[0][0]
        document.getElementById("page_2tag25").innerHTML = data[0].acadmic_details_school[0][1]
        document.getElementById("page_2tag26").innerHTML = data[0].acadmic_details_school[0][2]
        document.getElementById("page_2tag27").innerHTML = data[0].acadmic_details_school[0][3]
        document.getElementById("page_2tag28").innerHTML = data[0].acadmic_details_school[0][4]



        document.getElementById("page_2tag29").innerHTML = data[0].acadmic_details_school[1][0]
        document.getElementById("page_2tag30").innerHTML = data[0].acadmic_details_school[1][1]
        document.getElementById("page_2tag31").innerHTML = data[0].acadmic_details_school[1][2]
        document.getElementById("page_2tag32").innerHTML = data[0].acadmic_details_school[1][3]
        document.getElementById("page_2tag33").innerHTML = data[0].acadmic_details_school[1][4]

    populateTable( data[0].additional_edu , 'page2_t1')

    document.getElementById("page3_1").innerHTML = data[0].present_employment[0]
    document.getElementById("page3_2").innerHTML =data[0].present_employment[1]
    document.getElementById("page3_3").innerHTML =data[0].present_employment[3]
    document.getElementById("page3_4").innerHTML =data[0].present_employment[4]
    document.getElementById("page3_5").innerHTML =data[0].present_employment[5]

    populateTable_alt(data[0].employ_history,"page3_t1")
    populateTable_alt(data[0].teach_exp,"page3_t2")
    populateTable_alt(data[0].research_exp,"page3_t3")
    populateTable_alt(data[0].industrial_exp,"page3_t4")
    document.getElementById("page3_6").innerHTML =data[0].area_spec
    document.getElementById("page3_7").innerHTML =data[0].curr_research

    document.getElementById("page4_1").innerHTML =  data[0].summary_publication[0]
    document.getElementById("page4_2").innerHTML = data[0].summary_publication[1]
    document.getElementById("page4_3").innerHTML = data[0].summary_publication[2]
    document.getElementById("page4_4").innerHTML = data[0].summary_publication[3]
    document.getElementById("page4_5").innerHTML = data[0].summary_publication[4]
    document.getElementById("page4_6").innerHTML = data[0].summary_publication[5]
    document.getElementById("page4_7").innerHTML = data[0].summary_publication[6]

    populateTable_num(data[0].best_publication,"page4_t1")
    populateTable_num(data[0].patent,"page4_t2")
    populateTable_num(data[0].book,"page4_t3")
    populateTable_num(data[0].book_chapter,"page4_t4")

    document.getElementById("page4_8").children[0].innerHTML = data[0].scholar_link
    document.getElementById("page4_8").children[0].setAttribute("href", data[0].scholar_link)
    

    populateTable_num(data[0].membership,"page5_t1")
    populateTable_num(data[0].training,"page5_t2")
    populateTable_num(data[0].award,"page5_t3")
    populateTable_num(data[0].spon_project,"page5_t4")
    populateTable_num(data[0].cons_project,"page5_t5")
 


    populateTable_num(data[0].thesis,"page6_t1")
    populateTable_num(data[0].mtech,"page6_t2")
    populateTable_num(data[0].btech,"page6_t3")

    document.getElementById("page7_1").innerHTML = data[0].research
    document.getElementById("page7_2").innerHTML = data[0].course
    document.getElementById("page7_3").innerHTML = data[0].other
    document.getElementById("page7_4").innerHTML = data[0].edtor
    document.getElementById("page7_5").innerHTML = data[0].journal
    document.getElementById("page7_6").innerHTML = data[0].conference
    populateTable(data[0].referral,"page8_t1")
...
if(window.location.href.includes( "page0" )){get_page0()}