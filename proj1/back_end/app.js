...
import { get_page , login_check , signup, submit_page2 , submit_page1 , submit_page3 , submit_page4 , submit_page5, submit_page6 , submit_page7 , submit_page8,submit_page9 , get_pdf_info} from "./database.js";
...
app.get("/api/get_pdf_info/:email", async (req, res) => {
